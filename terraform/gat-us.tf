...
resource "aws_route53_record" "training-vm-us-40" {
  zone_id = var.training-gxp-us
  name    = "gat-40.us.galaxy.training"
  type    = "A"
  ttl     = "7200"
...
resource "aws_route53_record" "training-vm-us-40-wildcard" {
  zone_id = var.training-gxp-us
  name    = "*.interactivetoolentrypoint.interactivetool.gat-40.us.galaxy.training"
  type    = "CNAME"
  ttl     = "7200"
  records = ["gat-40.us.galaxy.training"]
}

resource "aws_route53_record" "training-vm-us-41" {
  zone_id = var.training-gxp-us
  name    = "gat-41.us.galaxy.training"
  type    = "A"
  ttl     = "7200"
...
resource "aws_route53_record" "training-vm-us-41-wildcard" {
  zone_id = var.training-gxp-us
  name    = "*.interactivetoolentrypoint.interactivetool.gat-41.us.galaxy.training"
  type    = "CNAME"
  ttl     = "7200"
  records = ["gat-41.us.galaxy.training"]
}

resource "aws_route53_record" "training-vm-us-42" {
  zone_id = var.training-gxp-us
  name    = "gat-42.us.galaxy.training"
  type    = "A"
  ttl     = "7200"
...
resource "aws_route53_record" "training-vm-us-42-wildcard" {
  zone_id = var.training-gxp-us
  name    = "*.interactivetoolentrypoint.interactivetool.gat-42.us.galaxy.training"
  type    = "CNAME"
  ttl     = "7200"
  records = ["gat-42.us.galaxy.training"]
}

resource "aws_route53_record" "training-vm-us-43" {
  zone_id = var.training-gxp-us
  name    = "gat-43.us.galaxy.training"
  type    = "A"
  ttl     = "7200"
...
resource "aws_route53_record" "training-vm-us-43-wildcard" {
  zone_id = var.training-gxp-us
  name    = "*.interactivetoolentrypoint.interactivetool.gat-43.us.galaxy.training"
  type    = "CNAME"
  ttl     = "7200"
  records = ["gat-43.us.galaxy.training"]
}

resource "aws_route53_record" "training-vm-us-44" {
  zone_id = var.training-gxp-us
  name    = "gat-44.us.galaxy.training"
  type    = "A"
  ttl     = "7200"
...
resource "aws_route53_record" "training-vm-us-44-wildcard" {
  zone_id = var.training-gxp-us
  name    = "*.interactivetoolentrypoint.interactivetool.gat-44.us.galaxy.training"
  type    = "CNAME"
  ttl     = "7200"
  records = ["gat-44.us.galaxy.training"]
}
