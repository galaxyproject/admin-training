...
generate-slides:
	...
	# Other topics not updated/covered in this training
	...
	# $(IN_VENV) python slideshow/build_slideshow.py 'When Things Go Wrong' sessions/22-troubleshooting/troubleshooting.md 22-troubleshooting
