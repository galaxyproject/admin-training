...
idea to run it in a _screen_ since networks are sometimes flaky). We have also limited the set It should
take about 5-10 minutes for the playbook to run to completion.
