...
- [Sample advanced job config](https://github.com/galaxyproject/dagobah-training/blob/master/advanced/15-job-conf/job_conf.sample_advanced.xml) (copied for syntax highlighting)
