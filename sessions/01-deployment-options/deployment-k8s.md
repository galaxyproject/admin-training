...
---
class: special
# Deployment Options and Overview
...
![galaxy-installation](images/galaxy-installation.svg)

---

# Galaxy Installation: Explained 1

- *Web Handlers*

  A Galaxy process which handles web requests.
  No. of processes can be increased to handle more users.

- *Job Handlers*

  A Galaxy process which monitors and manages jobs as they execute, such
  as dispatching the job to the job scheduler, getting the results back,
  and showing the status of the job (pending, running, finished, error)

---

# Galaxy Installation: Explained 2

- *Database*

  Stores Galaxy metadata (see previous slides)
- *HostFS/user data*

  data uploaded by the user, or data generated by tools
   (see previous slides)

- *NGINX*
  A high-performance reverse-proxy server for production

---

# Galaxy Installation: Explained 3

- *Grafana*

  Visualization of cluster status, job status etc.

- *Keycloak*

  Handles authorization

**Setting up all of these parts in production can be complex,
but Kubernetes bundles all of this into a single command.**
